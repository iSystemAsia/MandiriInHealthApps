...
import 'package:mandiri_in_health/widgets/pipeline/new_business/data_badan_usaha.dart';
import 'package:mandiri_in_health/widgets/pipeline/new_business/data_kanal.dart';
import 'package:mandiri_in_health/widgets/pipeline/new_business/data_potensi_bisnis.dart';
import 'package:mandiri_in_health/widgets/pipeline/new_business/update_aktifitas.dart';
...
class PipelineNewBusinessDetail extends StatefulWidget {
  const PipelineNewBusinessDetail({Key? key, required this.item})
      : super(key: key);

  final PipelineModel item;

  @override
  State<PipelineNewBusinessDetail> createState() {
    return _PipelineNewBusinessDetailState();
  }
}

class _PipelineNewBusinessDetailState extends State<PipelineNewBusinessDetail> {
  ...
  Widget _buildContent(PipelineModel? pipeline) {
    ...
    Widget riwayatSalesActivity = dataKanal;
        ...
        children: [
          ...
          Visibility(
            ...
            child: Container(
              ...
              child: Text(
                "KOTA/KABUPATEN ${pipeline.Kabupaten!.toUpperCase()}\n" +
                    "KECAMATAN ${pipeline.Kecamatan!.toUpperCase()}\n" +
                    "KELURAHAN ${pipeline.Kelurahan!.toUpperCase()}\n" +
      ...
      dataKanal = Column(
        ...
        children: [
          ...
          Visibility(
              ...
              child: DataKanalNewBusinessDetail(item: pipeline)),
        ],
      );
      ...
      dataBadanUsaha = Column(
        ...
        children: [
          ...
          Visibility(
              ...
              child: DataBadanUsahaNewBusinessDetail(item: pipeline)),
        ],
      );
      ...
      dataPotensiBisnis = Column(
        ...
        children: [
          ...
          Visibility(
              ...
              child: DataPotensiBisnisNewBusinessDetail(item: pipeline)),
        ],
      );
      ...
      updateAktifitas = Column(
        ...
        children: [
          ...
          Visibility(
              ...
              child: UpdateAktifitasNewBusinessDetail(item: pipeline)),
        ],
      );
