...
class _HomeState extends State<Home> {
  ...
  void _onCategory(CategoryModel item) {
      ...
      print(item.count);
      print(item.image!.id);
      print(item.image!.thumb);
      print(item.image!.full);
      print(item.type);
      ...
      body: BlocBuilder<HomeCubit, HomeState>(
        builder: (context, state) {
          ...
          List<ProductModel>? recent;
			...
			List<CategoryModel> listMenuIcon = [
				new CategoryModel(
					id: 1, 
					title: "Pipeline", 
					image: new ImageModel(
						id: 8,
						full: "https://listarapp.com/wp-content/uploads/2020/05/category-2-1024x682.jpg",
						thumb: "https://listarapp.com/wp-content/uploads/2020/05/category-2-150x150.jpg"
					),
					icon: UtilIcon.getIconFromCss("fas fa-car"), 
					color: UtilColor.getColorFromHex("#fdc60a")
				),
				new CategoryModel(
					id: 2, 
