...
class _QuotationDetailState extends State<QuotationDetail> {
  ...
  Widget _buildContent(QuotationModel? quotation) {
    ...
    if (quotation != null) {
      ...
      ///Phone
      if (quotation.MdrPhoneNumber != null) {
        phone = Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const SizedBox(height: 12),
            InkWell(
              onTap: () {
                _phoneAction(quotation.MdrPhoneNumber!);
              },
              child: Row(
                children: <Widget>[
                  Container(
      ...
      if (quotation.MdrEmail != null) {
        email = Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                _makeAction('mailto:${quotation.MdrEmail}');
              },
              child: Row(
                children: <Widget>[
                  Container(
